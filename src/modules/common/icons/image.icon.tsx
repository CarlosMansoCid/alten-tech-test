...
interface IImageIcon extends SVGProps<SVGSVGElement> {}

function IconFileImage({ ...rest }: IImageIcon) {
  return (
    <svg viewBox="0 0 1024 1024" fill="currentColor" {...rest}>
...
export default memo(IconFileImage);
